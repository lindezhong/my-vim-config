...
" coc.vim 安装的
let g:coc_global_extensions = ['coc-word','coc-markdown-preview-enhanced','coc-webview','coc-translator', 'coc-json','coc-ultisnips-select', 'coc-java',  'coc-java-debug', 'coc-java-lombok', 'coc-pyright', 'coc-jedi', 'coc-tsserver', 'coc-clangd']
" # 插件安装需要做的事
" ## coc-clangd
" ### 安装
